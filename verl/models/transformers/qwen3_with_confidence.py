...
from .dense_common import CausalLMOutputWithConfidence, forward_base_model
...
class Qwen3ForCausalLMWithConfidence(Qwen3ForCausalLM):
    ...
    def forward_with_triton_backend(
        ...
        **kwargs
        ...
        """
        Forward pass using triton backend for efficient training.
        """
        breakpoint()
        # NOT TESTED

        # Use base forward implementation with triton optimizations
        ...
        # Confidence head computation
        confidence_logits = self.confidence_head(hidden_states)
        confidence_scores = torch.sigmoid(confidence_logits.squeeze(-1)).to(torch.float32)
